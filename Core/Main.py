...
def main(page: Page):
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('DogBomber', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('DogBomber', TextStyle(size=95, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                attack_button,
                Text('\n', size=12),
                Row([IconButton(icon='telegram', icon_size=48, tooltip='Канал', url='https://www.youtube.com/watch?v=dQw4w9WgXcQ', icon_color=color),
                    IconButton(icon='telegram', icon_size=48, tooltip='Владелец', url='https://www.youtube.com/watch?v=dQw4w9WgXcQ', icon_color=color),
                    IconButton(icon='attach_money', icon_size=48, tooltip='Донат', url='https://www.youtube.com/watch?v=dQw4w9WgXcQ', icon_color=color),
